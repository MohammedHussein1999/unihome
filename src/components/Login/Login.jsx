...
import imgLogin from '../Assets/4794658-removebg-preview.png'
...
export default function Login() {
    ...
    async function login() {
        try {
            let response = await axios.post("https://unih0me.com/api/auth/login", loginInput)
            console.log(response);
            // Cookies.set("userData", JSON.stringify(response.data))
            // console.log(JSON.parse( Cookies.get("userData")));
            localStorage.setItem("data",response.data.access_token)
            // console.log(localStorage.getItem("data"));
            
            navigate('/applicationTeacher')
    ...
    return <>
        ...
        <section className="h-screen login flex flex-row  flex-wrap justify-around items-center		">
            ...
            <div className="uniHomeImg xl:basis-1/3 md:basis-3/5 basis-7/12 ">
                <img src={imgLogin} alt="img Login" className='w-4/5 m-auto' />
            </div>
            ...
            <div class="formLogin xl:basis-2/5 lg:basis-2/5 basis-full">
                ...
                <div className=" flex bg-white rounded-lg shadow-lg border overflow-hidden w-full">
                    ...
                    <div className="w-full p-8 ">
                        <p className="text-2xl pb-5 text-gray-600 text-center">Welcome to Unihome</p>
                        <form onSubmit={submitLogin}>
                            ...
                            <div className="mt-4 flex flex-col justify-between">
                                ...
                                <input
                                    onChange={input}
                                    name="password" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="password" placeholder="******************" />

                                <Link to={'forgetPassword'} className="text-sm text-gray-500 font-bold hover:text-gray-900 text-end w-full mt-2">Forget Password?</Link>
                                ...
                                <div className='w-5/12 flex justify-between items-center'>
                                    ...
                                    <div className="textGoogle">
                                        <h1 className="whitespace-nowrap text-gray-600 font-bold text-lg">
                                            <span className='w-9 text-red-400'>Sign in with Google</span>
                                        </h1>
                                    </div>
                        ...
                        >
                            <div className="flex px-5 justify-center items-center  w-full py-3">
                                <div className='w-5/12 flex justify-between items-center'>
                                    ...
                                    <div className="textGoogle">
                                        <h1 className="whitespace-nowrap text-gray-600 font-bold text-lg">
                                            <span className='w-9 text-red-400'>Sign in with Facebook</span>
                                        </h1>
                                    </div>
