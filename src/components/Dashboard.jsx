...
import LessonCard from "./Sessions/LessonCard";
import axios from "axios";
import Cancelled from "./Sessions/Cancelled";
import Completed from "./Sessions/Completed";
  ...
  useEffect(() => {
    dataSession.map(async (e) => {
      let request = await axios.get(
        `https://unih0me.com/api/teacher/${e.student_id}`,
        {
          headers: {
      ...
      console.log(request.data.data.user.sessions);
